...
class main:
    ...
    def cur(self):
        ...
        try:
            ...
            self.bt9 = Tk.Button(self.fm3, text="Ram", bg='#a40000', font=('Candara', 15, 'bold'), width=150,height=0)
            ...
            def data(self):
                ...
                if self.value!=None:
                    if(self.flag!=1):
                        ...
                        self.x = date.today()
                        self.cal = Calendar(self.boot, selectmode="day", bg='black',year=2023,month=5,day=10)
    ...
    def returnbook(self):
        class retu(main):
            def __init__(self):            
                ...
                self.button9 = Button(self.f1, text='RETURN', bg='#581845', fg='#fff', width=8, height=0,font=('Calibri', 12, 'bold'),command=self.retbook,activebackground="#000",activeforeground="#581845")
    ...
    def show(self):
        class test(main):
            def __init__(self):
                ...
                self.book_table=Tk.Treeview(self.table_frame,columns=("Book ID","Title","Author","Edition","Price"),xscrollcommand=self.scroll_x.set,yscrollcommand=self.scroll_y.set)
